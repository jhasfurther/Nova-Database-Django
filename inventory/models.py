...
class Equipment (models.Model):
    ...
    Calibrated_By = models.CharField(blank=True, null=True, max_length=200,default=None, choices=[('National', 'National'),('ADTEK','ADTEK'),('In House', 'In House'),('Manufacturer','Manufacturer'),('Other','Other')])
    Current_Status = models.CharField(blank=True, null=True, max_length=200,default=None, choices=[('On Lease','On Lease'),('Missing','Missing'),('Need to be Repaired','Need to be Repaired'),('In Service','In Service'),('Out of Service','Out of Service')])
    Location_In_Lab = models.CharField(blank=True, null=True, max_length=200,default=None)
    ...
    Who_Is_It_Assigned_To = models.CharField(blank=True, null=True, max_length=200,default=None)
